...
DBT_DT_SYSTEM = load_prompt("DBT/dt_module_prompt.txt")
DBT_MIND_SYSTEM = load_prompt("DBT/mind_module_prompt.txt")
DBT_ER_SYSTEM = load_prompt("DBT/er_module_prompt.txt")
DBT_IE_SYSTEM = load_prompt("DBT/ie_module_prompt.txt")
